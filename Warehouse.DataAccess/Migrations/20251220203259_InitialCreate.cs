        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InQuantity = table.Column<int>(type: "int", precision: 18, scale: 3, nullable: false, defaultValue: 0),
                    OutQuantity = table.Column<int>(type: "int", precision: 18, scale: 3, nullable: false, defaultValue: 0),
                    BalanceAfter = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemVouchers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemVouchers_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemVouchers_ItemId_VoucherDate",
                table: "ItemVouchers",
                columns: new[] { "ItemId", "VoucherDate" });

            migrationBuilder.CreateIndex(
                name: "IX_ItemVouchers_VoucherCode",
                table: "ItemVouchers",
                column: "VoucherCode");
